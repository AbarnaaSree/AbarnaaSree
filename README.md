...
**Merged Pull Requests (auto-updated by GitHub Actions):**

<div align="center">
<img src="https://raw.githubusercontent.com/AbarnaaSree/AbarnaaSree/main/metrics.pulls.svg" width="100%" />
</div>

<sub>This panel is generated by the `lowlighter/metrics` workflow below — it lists your most recent pull requests with live merged/closed/open status, and refreshes automatically every 6 hours.</sub>
